...
function draw() {
  ...
  if (gameState === "play") {
    ...
    textSize(20);
    fill("black");
    text("Score: " + score, width - 1105, height - 869);
    text("Seconds Left: " + mainCounter, width - 1105 , height - 896);
  ...
  if (gameState === "stop") {
    ...
    fill("black");
    textSize(50);
    text("Your Score: " + score, width - 1180, height - 869);
    text("Trashed Plants: " + trashed_plants, width - 1180, height - 794);
    text("Harvested Plants: " + harvested, width - 1180, height - 719);
    textSize(20);
    text("Press Space to play Again", width/2 - 260, height/2);
    text("Press H to go back to Menu", width/2 - 260, height/2 + 50);
    play.visible = true;
    play.x = width/2 - 120;
    play.y = height/2 - 100;
    gameMusic.stop();
  ...
  if (gameState === "home") {
    ...
    fill("black");
    textSize(20);
    text("Press Space to Play", (width/2) - 105, height - 620);
    text("Press C to see Controls", width/2 - 400, height - 400);
    text("Press T to see How to play", width/2 + 50, height - 400);
    play.x = (width/2) - 25;
    play.y = height - 700;
  ...
  if (gameState === "how") {
    ...
    fill("black");
    textSize(28);
    text("Press H to go back to Menu", width/2, height/2 - 420);
    text("Press O to see objective", width/2, height/2 - 390);
    textSize(20);
